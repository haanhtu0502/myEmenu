...
class _EmenuConfigApi implements EmenuConfigApi {
  ...
  Future<HttpResponse<ResponseData<OrganizationModel>>> getTableById(
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<HttpResponse<ResponseData<OrganizationModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ResponseData<OrganizationModel> _value;
    try {
      _value = ResponseData<OrganizationModel>.fromJson(
        _result.data!,
  ...
  @override
  Future<HttpResponse<ResponseData<dynamic>>> sendNotification(
      {required Map<String, dynamic> queries}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/app/api/v1/requestOrder/sendNotify',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
